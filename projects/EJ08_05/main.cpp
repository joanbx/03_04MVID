/*
EJ08.05 - Intentar crear un mapa specular (con algún editor de imagenes Photoshop, Gimp, ...) a partir de un mapa difuso que en lugar de blanco y negro use colores reales, 
...
int main(int, char* []) {
	...
	const Texture t_specular("../assets/textures/bricks_specular_EJ08_05.png", Texture::Format::RGB); //bricks_specular -> bricks_specular_EJ08_05
