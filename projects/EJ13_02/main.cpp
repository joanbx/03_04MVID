...
void render(const Geometry& quad, const Geometry& cube, const Shader& s_phong, const Shader& s_fbo,
	...
	s_fbo.set("offset", 1.0f / (Window::instance()->getWidth() / 2), 1.0f / (Window::instance()->getHeight() / 2));
...
int main(int, char* []) {
	...
	const Shader s_fbo("../projects/EJ13_02/fbo.vs", "../projects/EJ13_02/fbo.fs"); //<-Ver Shader para comprobar el efecto Sobel
