...
glm::vec3 grassPositions[] = {
	glm::vec3(4.0f, 0.0f, 0.501f),
	glm::vec3(-4.0f, -0.0f, 0.501f),
	glm::vec3(0.0f, -0.0f, 4.501f),
	glm::vec3(0.0f, -0.0f, -3.499f),
	glm::vec3(4.0f, -0.0f, 4.501f),
	glm::vec3(4.0f, -0.0f, -3.499f),
	glm::vec3(-4.0f, -0.0f, 4.501f),
	glm::vec3(-4.0f, -0.0f, -3.499f),
};
...
void render(const Geometry& floor, const Geometry& object, const Shader& s_phong, const Shader& s_blend,
	const Texture& t_albedo, const Texture& t_specular, Texture& t_albedo2, Texture& t_specular2, const Texture& t_tree) {
	...
	t_albedo2.use(s_phong, "material.diffuse", 0);
	t_specular2.use(s_phong, "material.specular", 1);
...
int main(int, char* []) {
	...
	const Texture t_albedo("../assets/textures/Wood/Bolted_Wooden_Planks_DIFF.jpg", Texture::Format::RGB);
	const Texture t_specular("../assets/textures/Wood/Bolted_Wooden_Planks_SPEC.jpg", Texture::Format::RGB);
	Texture t_albedo2("../assets/textures/bricks_albedo.png", Texture::Format::RGB);
	Texture t_specular2("../assets/textures/bricks_specular.png", Texture::Format::RGB);
	const Texture t_tree("../assets/textures/dirty-decals.png", Texture::Format::RGBA);
	...
	while (window->alive()) {
		...
		render(quad, cube, s_phong, s_blend, t_albedo, t_specular, t_albedo2, t_specular2, t_tree);
		window->frame();
	}
