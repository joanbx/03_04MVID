...
std::vector<QuadColors> quadColors{
	{glm::vec3(0.0f, 0.0f, -1.8f),glm::vec3(1.0f,0.0f,0.0f),0.3f},
	{glm::vec3(0.0f, 0.0f, -1.9f),glm::vec3(0.0f,1.0f,0.0f),0.25f},
	{glm::vec3(0.0f, 0.0f, -2.0f),glm::vec3(0.0f,0.0f,1.0f),0.20f}
...
void render(const Geometry& quad, const Shader& s_phong, const Shader& s_blend, const Shader& s_blendColor,
	...
	//Iteramos de mas lejos a mas cerca
	s_blendColor.use();
