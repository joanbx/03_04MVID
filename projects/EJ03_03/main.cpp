...
void render(uint32_t VAO, const Shader& shader) {
	...
	shader.set("offsetPos", sin(timeLapse)/2.0f, cos(timeLapse)/2.0f,0.0f); //Lo movemos en vertical y en horizontal, si queremos solo vertical ponemos el segundo valor a 0.
