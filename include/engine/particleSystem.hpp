...
//Class Particle: Represents a single particle and its state
struct Particle {
...
//Class ParticleSystem ParticleGenerator acts as a container for rendering a large number of 
...
public:
	...
	void Update(float dt,GLuint newParticles, GameObject& go,glm::vec3 offset = glm::vec3(0.0f, 0.0f,0.0f), float maxScale=5.0f);
	//Draw: Render all particles
	void Draw(glm::mat4& proj, glm::mat4& view);
	//getFinished: return finish state
	bool getFinished() { return _finish; }
	//aetFinished: sets finish state
