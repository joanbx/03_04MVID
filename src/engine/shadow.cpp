...
void Shadow::FirstPass() {
	...
	const glm::mat4 lightView = glm::lookAt(_direction, glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	const glm::mat4 lightSpaceMatrix_ = lightProjection * lightView;

	//lightSpaceMatrix = lightProjection * lightView;

	_depth.use();
	_depth.set("lightSpaceMatrix", lightSpaceMatrix_);
...
void Shadow::setDepthMap(const Shader& shader) {
	//SECOND PASS
	const glm::mat4 lightProjection = glm::ortho(-10.0f, 10.0f, -10.0f, 10.0f, k_shadow_near, k_shadow_far);
	const glm::mat4 lightView = glm::lookAt(glm::vec3(1.2f, 5.0f, 4.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	const glm::mat4 lightSpaceMatrix_ = lightProjection * lightView;
	shader.set("lightSpaceMatrix", lightSpaceMatrix_);
